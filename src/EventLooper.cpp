...
void EventLooper::Loop()
{
  ...
  // Trigger decisions
  passTrigger_HLT_IsoMu27      = branches_.passTrigger_HLT_IsoMu27;
  passTrigger_HLT_PFHT1050     = branches_.passTrigger_HLT_PFHT1050;
  passTrigger_6J1T_B           = branches_.passTrigger_6J1T_B;
  passTrigger_6J1T_CDEF        = branches_.passTrigger_6J1T_CDEF;
  passTrigger_6J2T_B           = branches_.passTrigger_6J2T_B;
  passTrigger_6J2T_CDEF        = branches_.passTrigger_6J2T_CDEF;
  passTrigger_4J3T_B           = branches_.passTrigger_4J3T_B;
  passTrigger_4J3T_CDEF        = branches_.passTrigger_4J3T_CDEF;

  // Object counts
  nMuons                       = branches_.nMuons;
  nElecs                       = branches_.nElecs;
  nJets                        = branches_.nJets;
  // nbJets                      = branches_.nbJets;   // uncomment if needed

  // Event-level quantities
  HT                           = branches_.HT;

  // Jet kinematics (array or vector)
  //jetPt                        = branches_.jetPt;
  std::copy(std::begin(branches_.jetPt),
          std::end(branches_.jetPt),
          jetPt);
//  std::copy(std::begin(branches_.jetEta),
//          std::end(branches_.jetEta),
//        jetEta);
//  jetEta                     = branches_.jetEta;   // uncomment if needed
//  bTagScore                  = branches_.bTagScore; // uncomment if needed

  // Weights and filters
  PUWeight                     = branches_.PUWeight;
  L1PrefiringWeight            = branches_.L1PrefiringWeight;
  failGoldenJson               = branches_.failGoldenJson;
  passMETFilters               = branches_.passMETFilters;
...
//
  ...
  branches_.SetBranchAddresses(fChain);
  branches_.SetDebug(true);
//  br.DisableBranch("jetEta");
